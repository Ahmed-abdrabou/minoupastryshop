...
const MiniCakes = () => (
  <div className="section__padding section_container Small_flex_column_reverse MiniCakes">
    ...
    <div className="section_Text_container">
      ...
      <p>
        We offer specially designed cakes for those of you looking for more than
        an ordinary cake. Whether you are throwing a surprise party, celebrating
        a birthday, engagement or getting married, we are sure to create a
        beautiful and unique cake for your special occasion.
      </p>
      <span className="custom__button section_container_button">
        Order Now..
      </span>
    </div>
  </div>
